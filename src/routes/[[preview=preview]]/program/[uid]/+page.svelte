...
<div class="relative min-h-screen md:flex" data-dev-hint="container">
    ...
    <header class="bg-surface-600 text-primary-500 flex justify-between md:hidden" data-dev-hint="mobile menu bar">
        <a href="#" class="block p-4 text-primary-50 font-bold whitespace-nowrap truncate">
           Current Students
        </a>

        <label for="menu-open" id="mobile-menu-button" class="m-2 p-2 focus:outline-none hover:text-white hover:bg-surface-700 rounded-md">
...
<Bounded>
	<h1 class="text-5xl font-medium md:text-7xl">
		<PrismicText field={data.page.data.program_name} />
	</h1>
	<p class="mb-4 mt-8 prose prose-xl max-w-xl  text-yellow-500">
		{data.page.data.program_tag_line}
	</p>
	
		<PrismicImage class="rounded-full" field={data.page.data.program_image} />
...
<div class="px-4 py-6 sm:px-0">
	<div class="prose prose-inverted mx-auto text-primary-50 mt-7 md:mt-11">
