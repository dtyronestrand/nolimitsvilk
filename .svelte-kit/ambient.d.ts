...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies__iconify_json_ph: string;
	export const TERM: string;
	export const SHELL: string;
	export const TMPDIR: string;
	export const HOMEBREW_REPOSITORY: string;
	export const npm_package_devDependencies_typescript_svelte_plugin: string;
	...
	export const npm_package_dependencies_mini_svg_data_uri: string;
	export const SSH_AUTH_SOCK: string;
	export const npm_package_devDependencies_eslint: string;
	export const __CF_USER_TEXT_ENCODING: string;
	export const npm_execpath: string;
	export const npm_package_devDependencies_tslib: string;
	export const npm_package_scripts_vite_dev: string;
	export const npm_package_dependencies__fontsource_protest_riot: string;
	...
	export const npm_package_devDependencies__iconify_json_ep: string;
	...
	export const npm_package_scripts_slicemachine: string;
	export const NVM_BIN: string;
	export const npm_config_user_agent: string;
	export const npm_package_devDependencies__slicemachine_adapter_sveltekit: string;
	export const npm_package_dependencies_clsx: string;
	export const npm_package_devDependencies_slice_machine_ui: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_devDependencies__iconify_json_ph: string;
		TERM: string;
		SHELL: string;
		TMPDIR: string;
		HOMEBREW_REPOSITORY: string;
		npm_package_devDependencies_typescript_svelte_plugin: string;
		...
		npm_package_dependencies_mini_svg_data_uri: string;
		SSH_AUTH_SOCK: string;
		npm_package_devDependencies_eslint: string;
		__CF_USER_TEXT_ENCODING: string;
		npm_execpath: string;
		npm_package_devDependencies_tslib: string;
		npm_package_scripts_vite_dev: string;
		npm_package_dependencies__fontsource_protest_riot: string;
		...
		npm_package_devDependencies__iconify_json_ep: string;
		HOME: string;
		SHLVL: string;
		...
		npm_package_scripts_slicemachine: string;
		NVM_BIN: string;
		npm_config_user_agent: string;
		npm_package_devDependencies__slicemachine_adapter_sveltekit: string;
		npm_package_dependencies_clsx: string;
		npm_package_devDependencies_slice_machine_ui: string;
